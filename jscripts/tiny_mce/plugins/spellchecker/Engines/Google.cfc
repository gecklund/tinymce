...
<cfcomponent output="False">
	...
	<cffunction name="SendToGoogle" output="False" returntype="Struct">
		...
		<cftry>
			...
			<!---
			DMZ doesn't allow outbound HTTP requests, so use a proxy instead
			Richard.Davies@portlandoregon.gov 
			<cf_httpProxy method="post" url="https://www.google.com/tbproxy/spell?lang=#ARGUMENTS.Language#" timeout="5" result="cfhttp">
			   <cf_httpProxyParam value="#xmlpacket#" type="body">
			</cf_httpProxy>--->
